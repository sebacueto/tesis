...
\begin{tabular}{@{}ccccc@{}}
\toprule
\multirow{2}{*}{Ítem} & \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Condición de humedad \\ de la madera\end{tabular}} & \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Condición considerada para la madera\\  en la determinación de su(s)\end{tabular}} \\ \cmidrule(l){2-5} 
