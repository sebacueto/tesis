...
\label{sec:sol_gen}
A la matriz con cada combinación de la masa de los contrapesos, escritas en el orden de la tabla de cargas, se denomina \textit{''MassT''}
\begin{lstlisting}
MassT;
...
for i = 1:1:length(M)
    ...
    m1 = M(i,1); % Combinaciones contenidas en la matriz MassT
    m2 = M(i,2);
    ...
    save('resultados_tabla_25','F25','dm','Me','Fmax25');
