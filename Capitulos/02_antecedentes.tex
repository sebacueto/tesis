...
\caption{Curva de esfuerzo-deformación ingenieril (A) y real (B) de un acero. Los puntos representan: [1] Esfuerzo último ($\sigma_u$), [2] esfuerzo de fluencia ($\sigma_y$), [3] esfuerzo de ruptura, [4] región de endurecimiento por deformación y [5] región de estricción.}
